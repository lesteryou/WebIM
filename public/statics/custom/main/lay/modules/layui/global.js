...
layui.define(['code', 'element', 'table', 'util'], function(exports) {
    ...
    layer.ready(function() {
        ...
        if (local.version && local.version !== layui.v) {
            layer.open({
                ...
                moveType: 1 //拖拽模式，0或者1
                    ,
                content: ['<div class="layui-text">', 'layui 已更新到：<strong style="padding-right: 10px; color: #fff;">v' + layui.v + '</strong> <br>请注意升级！', '</div>'].join(''),
        ...
        layer.open({
            ...
            moveType: 1 //拖拽模式，0或者1
                ,
            content: ['<div class="layui-text">', '<a href="http://fly.layui.com/jie/20572/" target="_blank" style="color: #fff;"> LayIM 限时特惠来袭，自动授权 </a>', '</div>'].join(''),
            skin: 'layui-layer-notice',
    ...
    $(function() {
        ...
        DemoCode.val([
            DemoCode.val(), '<body>', global.preview, '\n<script src="//res.layui.com/layui/dist/layui.js" charset="utf-8"></script>', '\n<!-- 注意：如果你直接复制所有代码到本地，上述js路径需要改成你本地的 -->', $('#LAY_democodejs').html(), '\n</body>\n</html>'
        ].join(''));
    });
